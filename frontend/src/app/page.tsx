...
export default function Home() {
  ...
  const copyStructure = (fromContainerId: string, toContainerId: string) => {
    const sourceTree = getPluginTree(fromContainerId);
    addPluginTree(toContainerId, JSON.parse(JSON.stringify(sourceTree))); // Deep copy the tree
    refreshContainer(toContainerId);
  };
